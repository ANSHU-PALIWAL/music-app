...
// defining data, working music, appling content, dowloading music js 
...
Array.from(document.getElementsByClassName('playlistPlay')).forEach((e) => {
    e.addEventListener('click', (el) => {
        ...
        poster_master_play.src = `data/img/${index}.jpg`;
        music.play();
        masterPlay.classList.remove('fa-play');
        masterPlay.classList.add('fa-pause');
...
let menu_list_active_button_2 = document.getElementById('menu_list_active_button_2');

menu_list_active_button_2.addEventListener('click', () => {
