...
const songs = [
    {
        ...
        poster: "data/img/arjit/1.jpg"
    },
    {
        id: 2,
        songName: `Khariyat <br>
        <div class="subtitle">Chhichhore</div>`,
        poster: "data/img/arjit/2.jpg"
    },
    {
        id: 3,
        songName: `Desh Mere<br>
        <div class="subtitle">Bhuj</div>`,
        poster: "data/img/arjit/3.jpg"
    },
    {
        id: 4,
        songName: `Dhoka <br>
        <div class="subtitle">Arjit Singh</div>`,
        poster: "data/img/arjit/4.jpg"
    },
    {
        id: 5,
        songName: `Tera Yaar Ho Me <br>
        <div class="subtitle">Arjit Singh</div>`,
        poster: "data/img/arjit/5.jpg"
    },
    {
        id: 6,
        songName: `Mahi Teri Chuniriya Lehraye <br>
        <div class="subtitle">Arjit Singh</div>`,
        poster: "data/img/arjit/6.jpg"
    },
    {
        id: 7,
        songName: `Galti Se Mistake <br>
        <div class="subtitle">Jagga Jasoos</div>`,
        poster: "data/img/arjit/7.jpg"
    },
    {
        id: 8,
        songName: `Humari Adhoori Kahani <br>
        <div class="subtitle">Arjit Singh</div>`,
        poster: "data/img/arjit/8.jpg"
    },
    {
        id: 9,
        songName: `Ek Raah Pe Tu Chal <br>
        <div class="subtitle">Arjit Singh</div>`,
        poster: "data/img/arjit/9.jpg"
    },
    {
        id: 10,
        songName: `Villain <br>
        <div class="subtitle">Arjit Singh</div>`,
        poster: "data/img/arjit/10.jpg"
    },
    {
        id: 11,
        songName: `Mere Yaara <br>
        <div class="subtitle">Arjit Singh</div>`,
        poster: "data/img/arjit/11.jpg"
    },
    {
        id: 12,
        songName: `Befikre <br>
        <div class="subtitle">Arjit Singh</div>`,
        poster: "data/img/arjit/12.jpg"
    },
    {
        id: 13,
        songName: `E Vatan <br>
        <div class="subtitle">Raazi</div>`,
        poster: "data/img/arjit/13.jpg"
    },
    {
        id: 14,
        songName: `Agar Tum Saath Ho <br>
        <div class="subtitle">Tamasha</div>`,
        poster: "data/img/arjit/14.jpg"
    },
    {
        id: 15,
        songName: `Pachtaoge <br>
        <div class="subtitle">Arjit Singh</div>`,
        poster: "data/img/arjit/15.jpg"
    }
];
// saved data js
...
Array.from(document.getElementsByClassName('playlistPlay')).forEach((e) => {
    e.addEventListener('click', (el) => {
        ...
        poster_master_play.src = `data/img/arjit/${index}.jpg`;
        music.play();
        masterPlay.classList.remove('fa-play');
        masterPlay.classList.add('fa-pause');
